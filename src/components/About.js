                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={{backgroundColor: props.mode==='dark'?'#212529':'white',color: props.mode==='dark'?'white':'black' }}>
                            ...
                            Welcome to <strong>TextTweak Box</strong>,your go-to destination for powerful text manipulation and enhancement tools! We understand the importance of efficient and effective text processing in today's digital age, and our Text Utility website is designed to empower users with a suite of essential tools to streamline and optimize their text-related tasks.
                        </div>
                    </div>
                </div>
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={{backgroundColor: props.mode==='dark'?'#212529':'white',color: props.mode==='dark'?'white':'black' }}>
                            ...
                            At <strong >TextTweak Box</strong>,we pride ourselves on providing a user-friendly platform that caters to a wide range of needs, from simple text formatting to more advanced manipulation. Whether you're a student working on an essay, a professional drafting an important document, or a developer handling code snippets, our Text Utility tools are here to make your life easier.
                        </div>
                    </div>
                </div>
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={{backgroundColor: props.mode==='dark'?'#212529':'white',color: props.mode==='dark'?'white':'black' }}>
                            ...
                            <ul>
                                ...
                                <li><strong>Character Count and Word Count:</strong> Keep track of your text length with our character and word count tools. Perfect for meeting those strict character limits.</li>
                                <li><strong>Case Conversion:</strong> Quickly convert text to uppercase, lowercase, title case, or sentence case. Maintain consistency and readability effortlessly.</li>
                                <li><strong>Remove Duplicates:</strong> Clean up your content by eliminating duplicate lines or words. Save time and ensure precision in your work.</li>
                            </ul>
